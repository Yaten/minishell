...
# MINISHELL="valgrind -q --leak-check=full --track-fds=yes ./bin/minishell"
MINISHELL="valgrind --show-leak-kinds=all --track-origins=yes --track-fds=yes --trace-children=yes --leak-check=full --suppressions=readline.supp ./bin/minishell"
# MINISHELL="./minishell"
